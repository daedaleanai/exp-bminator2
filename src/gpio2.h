...
enum GPIO_Pin {
	...
	PC0	  = GPIO_C | Pin_0,
	PD0	  = GPIO_D | Pin_0,
	PE0	  = GPIO_E | Pin_0, /* PF0   = GPIO_F|Pin_0  ,  PG0   = GPIO_G|Pin_0  , PH0   = GPIO_H|Pin_0  ,*/
	PA1	  = GPIO_A | Pin_1,
	PB1	  = GPIO_B | Pin_1,
	PC1	  = GPIO_C | Pin_1,
	PD1	  = GPIO_D | Pin_1,
	PE1	  = GPIO_E | Pin_1, /* PF1   = GPIO_F|Pin_1  ,  PG1   = GPIO_G|Pin_1  , PH1   = GPIO_H|Pin_1  ,*/
	PA2	  = GPIO_A | Pin_2,
	PB2	  = GPIO_B | Pin_2,
	PC2	  = GPIO_C | Pin_2,
	PD2	  = GPIO_D | Pin_2,
	PE2	  = GPIO_E | Pin_2, /* PF2   = GPIO_F|Pin_2  ,  PG2   = GPIO_G|Pin_2  , PH2   = GPIO_H|Pin_2  ,*/
	PA3	  = GPIO_A | Pin_3,
	PB3	  = GPIO_B | Pin_3,
	PC3	  = GPIO_C | Pin_3,
	PD3	  = GPIO_D | Pin_3,
	PE3	  = GPIO_E | Pin_3, /* PF3   = GPIO_F|Pin_3  ,  PG3   = GPIO_G|Pin_3  , PH3   = GPIO_H|Pin_3  ,*/
	PA4	  = GPIO_A | Pin_4,
	PB4	  = GPIO_B | Pin_4,
	PC4	  = GPIO_C | Pin_4,
	PD4	  = GPIO_D | Pin_4,
	PE4	  = GPIO_E | Pin_4, /* PF4   = GPIO_F|Pin_4  ,  PG4   = GPIO_G|Pin_4  , PH4   = GPIO_H|Pin_4  ,*/
	PA5	  = GPIO_A | Pin_5,
	PB5	  = GPIO_B | Pin_5,
	PC5	  = GPIO_C | Pin_5,
	PD5	  = GPIO_D | Pin_5,
	PE5	  = GPIO_E | Pin_5, /* PF5   = GPIO_F|Pin_5  ,  PG5   = GPIO_G|Pin_5  , PH5   = GPIO_H|Pin_5  ,*/
	PA6	  = GPIO_A | Pin_6,
	PB6	  = GPIO_B | Pin_6,
	PC6	  = GPIO_C | Pin_6,
	PD6	  = GPIO_D | Pin_6,
	PE6	  = GPIO_E | Pin_6, /* PF6   = GPIO_F|Pin_6  ,  PG6   = GPIO_G|Pin_6  , PH6   = GPIO_H|Pin_6  ,*/
	PA7	  = GPIO_A | Pin_7,
	PB7	  = GPIO_B | Pin_7,
	PC7	  = GPIO_C | Pin_7,
	PD7	  = GPIO_D | Pin_7,
	PE7	  = GPIO_E | Pin_7, /* PF7   = GPIO_F|Pin_7  ,  PG7   = GPIO_G|Pin_7  , PH7   = GPIO_H|Pin_7  ,*/
	PA8	  = GPIO_A | Pin_8,
	PB8	  = GPIO_B | Pin_8,
	PC8	  = GPIO_C | Pin_8,
	PD8	  = GPIO_D | Pin_8,
	PE8	  = GPIO_E | Pin_8, /* PF8   = GPIO_F|Pin_8  ,  PG8   = GPIO_G|Pin_8  , PH8   = GPIO_H|Pin_8  ,*/
	PA9	  = GPIO_A | Pin_9,
	PB9	  = GPIO_B | Pin_9,
	PC9	  = GPIO_C | Pin_9,
	PD9	  = GPIO_D | Pin_9,
	PE9	  = GPIO_E | Pin_9, /* PF9   = GPIO_F|Pin_9  ,  PG9   = GPIO_G|Pin_9  , PH9   = GPIO_H|Pin_9  ,*/
	PA10  = GPIO_A | Pin_10,
	PB10  = GPIO_B | Pin_10,
	PC10  = GPIO_C | Pin_10,
	PD10  = GPIO_D | Pin_10,
	PE10  = GPIO_E | Pin_10, /* PF10  = GPIO_F|Pin_10 ,  PG10  = GPIO_G|Pin_10 , PH10  = GPIO_H|Pin_10 ,*/
	PA11  = GPIO_A | Pin_11,
	PB11  = GPIO_B | Pin_11,
	PC11  = GPIO_C | Pin_11,
	PD11  = GPIO_D | Pin_11,
	PE11  = GPIO_E | Pin_11, /* PF11  = GPIO_F|Pin_11 ,  PG11  = GPIO_G|Pin_11 , PH11  = GPIO_H|Pin_11 ,*/
	PA12  = GPIO_A | Pin_12,
	PB12  = GPIO_B | Pin_12,
	PC12  = GPIO_C | Pin_12,
	PD12  = GPIO_D | Pin_12,
	PE12  = GPIO_E | Pin_12, /* PF12  = GPIO_F|Pin_12 ,  PG12  = GPIO_G|Pin_12 , PH12  = GPIO_H|Pin_12 ,*/
	PA13  = GPIO_A | Pin_13,
	PB13  = GPIO_B | Pin_13,
	PC13  = GPIO_C | Pin_13,
	PD13  = GPIO_D | Pin_13,
	PE13  = GPIO_E | Pin_13, /* PF13  = GPIO_F|Pin_13 ,  PG13  = GPIO_G|Pin_13 , PH13  = GPIO_H|Pin_13 ,*/
	PA14  = GPIO_A | Pin_14,
	PB14  = GPIO_B | Pin_14,
	PC14  = GPIO_C | Pin_14,
	PD14  = GPIO_D | Pin_14,
	PE14  = GPIO_E | Pin_14, /* PF14  = GPIO_F|Pin_14 ,  PG14  = GPIO_G|Pin_14 , PH14  = GPIO_H|Pin_14 ,*/
	PA15  = GPIO_A | Pin_15,
	PB15  = GPIO_B | Pin_15,
	PC15  = GPIO_C | Pin_15,
	PD15  = GPIO_D | Pin_15,
	PE15  = GPIO_E | Pin_15, /* PF15  = GPIO_F|Pin_15 ,  PG15  = GPIO_G|Pin_15 , PH15  = GPIO_H|Pin_15 ,*/
	PAAll = GPIO_A | Pin_All,
	PBAll = GPIO_B | Pin_All,
	PCAll = GPIO_C | Pin_All,
	PDAll = GPIO_D | Pin_All,
	PEAll = GPIO_E | Pin_All, /* PFAll = GPIO_F|Pin_All,  PGAll = GPIO_G|Pin_All, PHAll = GPIO_H|Pin_All,*/
};
