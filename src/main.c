...
static inline void handlecmdrx() {
	switch (cmdbuf_state) {
	case RESYNC:
    ...
    printf("CMDRX %s %ld bytes at address %lx", cmdbuf[8] ? "write":"read", decode_be_uint24(cmdbuf + 9), decode_be_uint32(cmdbuf + 12));
